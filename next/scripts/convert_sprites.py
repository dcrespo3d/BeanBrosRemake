...
def convert_game_sprites():
    ...
    bmp_fn = '../res/sprite_game_defs_bmp.bin'
    pal_fn = '../res/sprite_game_defs_pal.bin'

    sprite_set_def = [
        [
            "../art/col-smart-walk.png",
            "../art/col-smart-idle.png",
            "../art/col-smart-asleep.png",
            "../art/col-smart-dead.png",
            "../art/col-smarto-big-head.png",
        ],
        [
            "../art/col-dumber-big-head.png",
            "../art/col-dumb-walk.png",
            "../art/col-dumb-idle.png",
            "../art/col-dumb-asleep.png",
            "../art/col-dumb-dead.png",
        ],
        [
            "../art/enemy1.png",
            "../art/spikes.png",
        ...
        [
            "../art/col-smarto-big-shoes.png",
            "../art/col-dumber-big-shoes.png",
        ],
        [
            "../art/placeholder-16x16.png",
            "../art/sprite-allgray.png",
            "../art/sprite-allblack.png",
            "../art/sprite-font-12-index.png",
        ],
