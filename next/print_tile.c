...
void print_hex_word(uword val)
{
    ...
    ; PUSH DE   ; not needed as called routines does not clobber DE
    ; PUSH BC   ; not needed as called routines does not clobber BC
    LD H, 0
    LD L, E
    PUSH HL
    ...
    INC SP
    INC SP
    ; POP BC   ; not needed as called routines does not clobber BC
    ; POP DE   ; not needed as called routines does not clobber DE
